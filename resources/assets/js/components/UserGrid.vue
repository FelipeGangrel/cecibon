                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <tr v-for="row in gridData" v-bind:key="row">
                                ...
                                <td>
                                    <a v-bind:href="'/usuario/' + row.Id "> {{ row.Nome }}</a>
                                </td>
                                <td>
                                    {{ row.Criado }}
                                </td>
                                <td>
                                    <a v-bind:href="'/usuario/' + row.Id + '/edit'">
...
<script>
    export default {
        ...
        methods: {
            ...
            loadData: function() {
                $.getJSON('/api/users-data', function(data) {
                    ...
                    this.first_page_url = '/api/users-data?page=1';
                    this.last_page_url = '/api/users-data?page=' + this.last_page;
                    this.setPageNumbers();
                }.bind(this));
            },
                ...
                if (this.query == '' && getPage != null) {
                    ...
                    if (getPage != null) {
                        $.getJSON(getPage, function(data) {
                            ...
                            this.first_page_url = '/api/users-data?page=1&keyword=' + this.query;
                            this.last_page_url = '/api/users-data?page=' + this.last_page + '&keyword=' + this.query;
                            this.current_page = data.current_page;
